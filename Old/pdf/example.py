...
tfont_size(pdf,15)
tfont(pdf,'B')
pdf.multi_cell(w = 0, h = 15, txt = 'Cliente', border = 0,
         align = 'C', fill = 1)
tfont(pdf,'')
...
tcol_set(pdf, 'gray')
pdf.cell(w = 30, h = h_sep, txt = 'Nombre:', border = 0, 
         align = 'R', fill = 0)

tcol_set(pdf, 'black')         
pdf.cell(w = 30, h = h_sep, txt = 'Alex', border = 0,
         align = 'L', fill = 0)

tcol_set(pdf, 'gray')
pdf.cell(w = 45, h = h_sep, txt = 'Rut:', border = 0, 
         align = 'R', fill = 0)

tcol_set(pdf, 'black') 
pdf.multi_cell(w = 0, h = h_sep, txt = '9.999 999-9', border = 0,
         align = 'L', fill = 0)


# fila 2 --
tcol_set(pdf, 'gray')
pdf.cell(w = 32, h = h_sep, txt = 'Direccion:', border = 0, 
         align = 'R', fill = 0)

tcol_set(pdf, 'black')
pdf.cell(w = 34, h = h_sep, txt = 'Chuquillanqui', border = 0,
         align = 'L', fill = 0)

tcol_set(pdf, 'gray')
pdf.cell(w = 65, h = h_sep, txt = 'Fecha de la visita:', border = 0, 
         align = 'R', fill = 0)
...
# fila 3 --
tcol_set(pdf, 'gray')
pdf.cell(w = 40, h = h_sep, txt = 'Tipo de Visita:', border = 0, 
         align = 'R', fill = 0)

tcol_set(pdf, 'black')
pdf.cell(w = 30, h = h_sep, txt = 'Visita especial', border = 0,
         align = 'L', fill = 0)

tcol_set(pdf, 'gray')
pdf.cell(w = 67, h = h_sep, txt = 'Nombre Especialista:', border = 0, 
         align = 'R', fill = 0)

tcol_set(pdf, 'black')
pdf.multi_cell(w = 0, h = h_sep, txt = 'Homero Simpson', border = 0,
         align = 'L', fill = 0)
...
tfont_size(pdf,15)
tfont(pdf,'B')
pdf.cell(w = 0, h = 15, txt = 'Actividades Realizada', border = 0,ln = 2, align = 'C', fill = 1)
tfont(pdf,'')
...
pdf.cell(w = 70, h = 10, txt = 'Estado', border = 0, align = 'C', fill = 1)
pdf.multi_cell(w = 0, h = 10, txt = 'Nota', border = 0, align = 'C',
             fill = 1)
