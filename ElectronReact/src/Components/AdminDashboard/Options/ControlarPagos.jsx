...
function ControlarPagos() {
    ...
    React.useEffect(() => {  
        clientSearch()
    }, [clientsList, browserValue, displayOption]);
    ...
    //                     html: `<div className="flex flex-col"><p style='color:white'>Borrar usuarios puede causar errores si han interactuado mucho con el sistema</p>
    //                        <p className="text-red-500">La empresa vinculada a este usuario también será borrada</p> </div>`,
    //                     icon: 'warning',
    //                     background: '#272727',
    ...
    async function clientSearch(){
        ...
        for (const client of filteredClientsList){
            ...
            usersHTML.push(
                <div key={client["ID_CUENTA"]} className="h-16 bg-gray-700 flex hover:bg-gray-600 rounded-xl">
                    <div className="border-gray-600 border-t h-full mx-auto" style={{width: "98%",
                    display: "grid", gridTemplateColumns: "64px 1.3fr 1fr 0.5fr 0.5fr"}}>
                        ...
                        <div className="flex m-auto font-medium">
            ...
            <div className="dashboardOptionsBody bg-gray-700" style={{height: "100vh"}}>
                <div className="border-b border-gray-800 shadow-lg w-full h-16 grid select-none" style={{gridTemplateColumns: "200px 0.9fr 1fr"}}>
                    ...
                    <div className="text-gray-200 font-medium flex mr-auto my-auto space-x-4" id="clientDisplayOptionContainer">
                        ...
                        <div className={(displayOption === "2") ? selectedDisplayClasses : normalDisplayClasses} onClick={()=>setDisplayOption("2")}>Pagos</div>
                    </div>
