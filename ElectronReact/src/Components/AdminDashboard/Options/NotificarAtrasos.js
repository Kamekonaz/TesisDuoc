...
function didDateHappen(datetimeString){
...
function NotificarAtrasos() {
    ...
    function filterActivities(){
        ...
        let filteredActivitiesList = activitiesList[0].filter((actividad) => actividad["ESTADO"] === "0")
        filteredActivitiesList = activitiesList[0].filter((actividad) => didDateHappen(actividad["FECHA_ACTIVIDAD"]))
                ...
                <div className="h-20 bg-gray-700 flex hover:bg-gray-600 rounded-xl" key={activity["ID_ACTIVIDAD"]}>
                    ...
                    display: "grid", gridTemplateColumns: "260px 1.3fr 250px"}}>
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="flex">
                                <div className={`px-3 py-2 rounded w-28 text-center mx-auto bg-red-700`}>Atrasado</div>
                            </div>
                        </div>
...
export default NotificarAtrasos;
