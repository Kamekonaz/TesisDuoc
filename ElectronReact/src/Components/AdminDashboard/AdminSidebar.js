        ...
        <div className="fixed grid w-64 bg-gray-800" style={{gridTemplateRows: "150px 1fr 60px", height: "100vh"}}>
            <div className="flex items-center flex-col border-4 border-gray-900" style={{gridTemplateRows: "20px 1fr 20px"}}>
                <div className="flex w-full mb-2 border-gray-900 bg-gray-900">
                    <span className="text-xl font-medium italic text-gray-200 m-auto">Administrador</span>
                </div>
            ...
            <div className="overflow-y-hidden hover:overflow-y-auto flex flex-col space-y-2 mt-2">
                ...
                <NavLink to="/adminDashboard/dashboardOption0" className={activeDashboardOption === "dashboardOption0" ? selectedDashboardOptionClass : normalDashboardOptionClass} id="dashboardOption0">
                ...
                <NavLink to="/adminDashboard/dashboardOption1" className={activeDashboardOption === "dashboardOption1" ? selectedDashboardOptionClass : normalDashboardOptionClass} id="dashboardOption1">
                    <div className="w-6 h-6 transition duration-75 text-gray-400 group-hover:text-gray-900 group-hover:text-white">
                        <div className="fa-solid fa-user"></div>
                    </div>
                    <span className="ml-3">Profesionales</span>
                </NavLink>
                <NavLink to="/adminDashboard/dashboardOption2" className={activeDashboardOption === "dashboardOption2" ? selectedDashboardOptionClass : normalDashboardOptionClass} id="dashboardOption2">
                    <div className="w-6 h-6 transition duration-75 text-gray-400 group-hover:text-gray-900 group-hover:text-white">
                        <div className="fa-solid fa-user"></div>
                    </div>
                    <span className="ml-3">Clientes</span>
                </NavLink>
                <NavLink to="/adminDashboard/dashboardOption3" className={activeDashboardOption === "dashboardOption3" ? selectedDashboardOptionClass : normalDashboardOptionClass} id="dashboardOption3">
                    <div className="w-6 h-6 transition duration-75 text-gray-400 group-hover:text-gray-900 group-hover:text-white">
                ...
                <NavLink to="/adminDashboard/dashboardOption5" className={activeDashboardOption === "dashboardOption5" ? selectedDashboardOptionClass : normalDashboardOptionClass} id="dashboardOption5">
                    ...
                    <span className="ml-3">Visualizar Actividades</span>
                </NavLink>
                <NavLink to="/adminDashboard/dashboardOption6" className={activeDashboardOption === "dashboardOption6" ? selectedDashboardOptionClass : normalDashboardOptionClass} id="dashboardOption6">
                    <div className="w-6 h-6 transition duration-75 text-gray-400 group-hover:text-gray-900 group-hover:text-white">
