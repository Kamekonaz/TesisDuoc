...
function ProChat() {
    ...
    const handleKeyDown = (elem, e) => {
      ...
      async function sendAMessage(message){
            // sendMessage
            console.log(userData["RUT_USUARIO"],)
            const data = {
  ...
  return (
    <div style={{height: '100vh', maxWidth: '100vw'}} >
        ...
        <ProfessionalSidebar/>
        <div className="bg-gray-700 pl-64">
            <div className="grid text-gray-200" style={{height: "100vh", maxHeight: "100vh", gridTemplateRows: "80px 1fr 100px"}}>
                <div className="flex bg-gray-800">
                    <div onClick={()=> navigate("/professionalDashboard/dashboardOption4") }
